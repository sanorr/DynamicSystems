...
// DynamicSystems
#include "DynamicSystems/Lorenz.h"
#include "DynamicSystems/Rossler.h"
#include "DynamicSystems/Aizawa.h"
...
int main(int, char**)
{
    ...
    IMGUI_CHECKVERSION();
    ImGui::CreateContext(); ImPlot::CreateContext(); ImPlot3D::CreateContext();
    ...
    bool show_implot3d_demo_window = true;
    ...
    while (!done)
    {
        ...
        if (show_implot3d_demo_window)
          ImPlot3D::ShowDemoWindow(&show_implot3d_demo_window);

        // DynamicSystems
        DynamicSystems::DrawLorenzAttractor();
        DynamicSystems::DrawRosslerAttractor();
        DynamicSystems::DrawAizawaAttractor();
